...
# source(paste0("../", code_dir, "f_tau_rf.R"))
modelsummary(models_ms, coef_map=cm, add_rows=data.frame(t(fe_row)), gof_omit="AIC|BIC|Log.Lik", title="Inverse Conquest Values and Military Capability Ratios", stars=TRUE)
