...
- **Question:** Do observed policies reflect **preferences** of their progenitors or **constraints of anarchy?**
...
$$
\chi_{ij}(\bm{m}) = \frac{ \rho_{ij}(\bm{W}; \bm{\alpha}) m_{ij} }{ \rho_{ij}(\bm{W}; \bm{\alpha}) m_{ij} + m_{jj} }
$$
...
$$
\color{bcOrange} \chi_{ij} \color{black} (\bm{m}) = \frac{ \rho_{ij}(\bm{W}; \bm{\alpha}) m_{ij} }{ \rho_{ij}(\bm{W}; \bm{\alpha}) m_{ij} + m_{jj} }
$$

- $\color{bcOrange} \chi_{ij}$: probability $\color{bcOrange} i$ successfully conquers $\color{bcOrange} j$
...
$$
\chi_{ij}( \color{bcOrange} \bm{m} \color{black}) = \frac{ \rho_{ij}(\bm{W}; \bm{\alpha}) \color{bcOrange} m_{ij} \color{black} }{ \rho_{ij}(\bm{W}; \bm{\alpha}) \color{bcOrange} m_{ij} \color{black} + \color{bcOrange} m_{jj} \color{black} }
$$

- $\chi_{ij}$: probability $i$ successfully conquers $j$
- $\color{bcOrange} \bm{m}$: military effort
- $\color{bcOrange} m_{ij}$: effort $i$ dedicates toward threatening $j$
- $\color{bcOrange} m_{jj}$: effort $j$ dedicates toward self-defense
...
$$
\chi_{ij}(\bm{m}) = \frac{ \color{bcOrange} \rho_{ij} \color{black} (\bm{W}; \bm{\alpha}) m_{ij} }{ \color{bcOrange} \rho_{ij} \color{black} (\bm{W}; \bm{\alpha}) m_{ij} + m_{jj} }
$$

- $\chi_{ij}$: probability $i$ successfully conquers $j$
- $\bm{m}$: military effort
- $m_{ij}$: effort $i$ dedicates toward threatening $j$
- $m_{jj}$: effort $j$ dedicates toward self-defense
- $\color{bcOrange} \rho_{ij} \color{black} \in [0, 1]$: loss of strength gradient
...
$$
\chi_{ij}(\bm{m}) = \frac{ \rho_{ij} (\color{bcOrange} \bm{W} \color{black} ; \bm{\alpha}) m_{ij} }{ \rho_{ij} ( \color{bcOrange} \bm{W} \color{black} ; \bm{\alpha}) m_{ij} + m_{jj} }
$$
...
- $m_{ij}$: effort $i$ dedicates toward threatening $j$
- $m_{jj}$: effort $j$ dedicates toward self-defense
- $\rho_{ij} \in [0, 1]$: loss of strength gradient
...
$$
\color{bcOrange} \chi_{ij} (\bm{m}) \color{black} = \frac{ \rho_{ij} (\bm{W}; \bm{\alpha}) m_{ij} }{ \rho_{ij} (\bm{W}; \bm{\alpha}) m_{ij} + m_{jj} }
$$

**Reservation Values**

$$
\color{bcOrange} \chi_{ij} (\bm{m}) \color{black} G_j(\bm{\tau}_i^{j \star}; \tilde{\bm{\tau}}_{-j}) + \color{bcOrange}  \left( 1 - \chi_{ij} (\bm{m}) \right) \color{black} G_j(\tilde{\bm{\tau}}) - c_j
$$
...
$$
\chi_{ij} (\bm{m}) G_j(\bm{\tau}_i^{j \star}; \tilde{\bm{\tau}}_{-j}) + \left( 1 - \chi_{ij} (\bm{m}) \right) G_j(\tilde{\bm{\tau}}) - \color{bcOrange} c_j
$$
...
$$
\color{bcOrange} \underline{G}_{ji}(\bm{m}) \color{black} = \chi_{ij} (\bm{m})G_j(\bm{\tau}_i^{j \star}; \tilde{\bm{\tau}}_{-j}) + \left( 1 - \chi_{ij} (\bm{m}) \right) G_j(\tilde{\bm{\tau}}) - c_j
$$

. . . 

- No war $\implies G_i(\tilde{\bm{\tau}}) \geq \color{bcOrange} \underline{G}_{ji}(\bm{m})$ for all $i, j$
...
$$
\underline{G}_{ji}(\color{bcOrange} \bm{m} \color{black}) = \chi_{ij} (\color{bcOrange} \bm{m} \color{black}) G_j(\bm{\tau}_i^{j \star}; \tilde{\bm{\tau}}_{-j}) + \left( 1 - \chi_{ij} (\color{bcOrange}  \bm{m} \color{black}) \right) G_j(\tilde{\bm{\tau}}) - c_j
$$
...
$$
\underline{G}_{ji}(\bm{m}) = \chi_{ij} (\bm{m}) G_j(\bm{\tau}_i^{j \star}; \tilde{\bm{\tau}}_{-j}) + \left( 1 - \chi_{ij} (\bm{m}) \right) G_j(\tilde{\bm{\tau}}) - c_j
$$
...
**Structural Residual**
$$
\epsilon_{ij}(\bm{\theta}) = \tilde{\tau_{ij}}^\star(\bm{m}^\star; \bm{\theta}) - \tau_{ij}
$$
...
\begin{equation}
\begin{split}
\hat{\bm{\theta}} = \argmin_{\bm{\theta}} & \quad \sum_i \sum_j \epsilon_{ij}(\bm{\theta})
\end{split}
\end{equation}
