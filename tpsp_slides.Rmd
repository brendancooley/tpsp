...
\text{subject to} & \quad \underbrace{\tilde{\chi}_{ji}(\bm{Z}; \bm{\theta}) G_j \left( h (\tilde{\bm{\tau}} ) \right) + \left( 1 - \tilde{\chi}_{ji}(\bm{Z}; \bm{\theta}) \right) G_j \left( h( \bm{1}_i; \tilde{\bm{\tau}}_{-i} ) \right) - c_j \geq 0}_{\text{war constraint}} \quad \text{for all } j 
\end{split}
\end{equation*}
...
\begin{split}
\max_{ \tilde{\bm{\tau}}_i } & \quad G_i \left( h( \tilde{\bm{\tau}}_i; \tilde{\bm{\tau}}_{-i} ) \right) \\
\text{subject to} & \quad \color{bcOrange} \tilde{\chi}_{ji}(\bm{Z}; \bm{\theta}) \color{black} G_j \left( h (\tilde{\bm{\tau}} ) \right) + \left( 1 - \color{bcOrange} \tilde{\chi}_{ji}(\bm{Z}; \bm{\theta}) \color{black} \right) G_j \left( h( \bm{1}_i; \tilde{\bm{\tau}}_{-i} ) \right) - c_j \geq 0 \quad \text{for all } j
\end{split}
\end{equation*}
...
\begin{split}
\max_{ \tilde{\bm{\tau}}_i } & \quad G_i \left( h( \tilde{\bm{\tau}}_i; \tilde{\bm{\tau}}_{-i} ) \right) \\
\text{subject to} & \quad \tilde{\chi}_{ji}(\bm{Z}; \bm{\theta}) G_j \left( h (\tilde{\bm{\tau}} ) \right) + \left( 1 - \tilde{\chi}_{ji}(\bm{Z}; \bm{\theta}) \right) \color{bcOrange} G_j \left( h( \bm{1}_i; \tilde{\bm{\tau}}_{-i} ) \right) \color{black} - c_j \geq 0 \quad \text{for all } j
\end{split}
\end{equation*}
...
\begin{split}
\max_{ \tilde{\bm{\tau}}_i } & \quad G_i \left( h( \tilde{\bm{\tau}}_i; \tilde{\bm{\tau}}_{-i} ) \right) \\
\text{subject to} & \quad \tilde{\chi}_{ji}(\bm{Z}; \bm{\theta}) G_j \left( h (\tilde{\bm{\tau}} ) \right) + \left( 1 - \tilde{\chi}_{ji}(\bm{Z}; \bm{\theta}) \right) G_j \left( h( \bm{1}_i; \tilde{\bm{\tau}}_{-i} ) \right) - c_j \geq 0 \quad \text{for all } j
\end{split}
\end{equation*}
