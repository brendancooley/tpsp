...
- Unobservables ($\bm{\theta}$)
	...
	+ $\alpha$ -- geographic loss of strength gradient [@Boulding1962; @BuenodeMesquita1980; @Diehl1985; @Lemke1995; @Gartzke2011]
...
**Economic Consequences: Trade flows contract `r round(cftcl_trade_diff_frac*100, 1)` percent in absence of coercion**

```{r X_diff_pp1, echo=FALSE, warning=FALSE, message=FALSE, fig.align="center", fig.height=fig_height_intro}
...
```{r X_diff_pp2, echo=FALSE, warning=FALSE, message=FALSE, fig.align="center", fig.height=fig_height_intro}
