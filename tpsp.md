...
I reformulate the estimation problem (\ref{eq:estimator}) in a similar manner. By Assumption `AGText`, at any Nash equilibrium, we must have
$$
...
\begin{split}
\min_{ \bm{\theta}_m, \hat{\tilde{\bm{\tau}}}, \hat{\bm{w}} } & \quad \epsilon_{ij} \\
