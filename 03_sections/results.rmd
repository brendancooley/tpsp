...
```{r war_costs, echo=FALSE, warning=FALSE, message=FALSE, results='asis', fig.cap = paste0("Estimated relative war costs against fixed adversary. United States' costs serve as baseline ($c=1$). \\label{fig:war_costs}"), fig.height=4.5, fig.width=4.5, dpi=300, fig.pos="t"}
