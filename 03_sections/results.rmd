...
```{r fit, echo=FALSE, warning=FALSE, message=FALSE, results='asis', fig.cap = paste0("Correlation between trade barrier data and model predictions. \\label{fig:fit}"), fig.height=5, dpi=300, fig.pos="t"}
