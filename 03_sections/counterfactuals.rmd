...
```{r cfct1_welfare, echo=FALSE, warning=FALSE, message=FALSE, results='asis', fig.cap = paste0("Changes in government welfare and consumer welfare (calculated by setting $v_i=1$ for all $i$) induced by moving from coercion-free equilibrium to baseline equilibrium. \\label{fig:cfct1_welfare}"), fig.height=5, dpi=300, fig.pos="t"}
...
```{r milex_2030, echo=FALSE, warning=FALSE, message=FALSE, results='asis', fig.cap = paste0("Projected military spending in 2030, assuming military budgets grow at observed average growth rate between 2011 and 2018. \\label{fig:milex_2030}"), fig.height=5, dpi=300, fig.pos="t"}
...
```{r cfct2_tau, echo=FALSE, warning=FALSE, message=FALSE, results='asis', fig.cap = paste0("Changes in Chinese trade policies under multipolarization. \\label{fig:cfct2_tau}"), fig.height=4, dpi=300, fig.pos="t"}
...
```{r war_probs_pp4, echo=FALSE, warning=FALSE, message=FALSE, results='asis', fig.cap = paste0("Changes in probability of war against China after Chinese preference liberalization. \\label{fig:war_probs_pp4}"), fig.height=4, dpi=300, fig.pos="t"}
